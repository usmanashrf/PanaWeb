...
import { cardsVariants, fadeIn, introVariants, qtr1Variants, slideIn, staggerContainer, textVariant } from "../utils/motions";
        ...
        >
          ...
          >
            ...
            >
              ...
              3D, AI, IOT
                ...
                <Flex pl={["20px", "0px", "0px"]} alignSelf={"flex-end"}>
                  {" "}
                  <Stat>
                    <StatLabel
                    ...
                    <StatNumber fontSize={["16px", "18px", "26px"]}>
                      3500+
                    </StatNumber>
          ...
          <Flex ml={["-25px", "0", "0"]} w={["90%", "60%"]}>
            ...
            >
              ...
              >
                  {" "}
                  <Image src="mobilePic.png" ml={"20px"}></Image>
                  </motion.nav>
                </Show>
              </div>
            </motion.div>
